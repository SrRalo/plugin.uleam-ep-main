...
<div class="wrap bform-admin-wrap bform-admin-wrap--full bform-admin-wrap--principal">
	...
	<section class="bform-panel">
		<header class="bform-panel-header">
			<h2><?php esc_html_e( 'Listado de Formularios', 'bform' ); ?></h2>
			<a class="button" href="<?php echo esc_url( $constructor_page_url ); ?>"><?php esc_html_e( 'Ir al Constructor', 'bform' ); ?></a>
		</header>

		<table class="widefat fixed striped bform-table">
			<thead>
				<tr>
			...
			<tbody>
				<?php if ( empty( $principal_forms ) ) : ?>
					<tr>
						<td colspan="6"><?php esc_html_e( 'Todavía no has creado formularios.', 'bform' ); ?></td>
					</tr>
				<?php else : ?>
					<?php foreach ( $principal_forms as $principal_form ) : ?>
						...
						<tr>
							...
							<td>
								<button type="button" class="button bform-copy-shortcode" data-shortcode="<?php echo esc_attr( $shortcode ); ?>">
									<?php esc_html_e( 'Copiar código', 'bform' ); ?>
								</button>
							</td>
							<td><?php echo esc_html( $form_date ); ?></td>
							<td class="bform-row-actions">
								<a class="button" href="<?php echo esc_url( $edit_url ); ?>"><?php esc_html_e( 'Editar', 'bform' ); ?></a>
								<a class="button" href="<?php echo esc_url( $duplicate_url ); ?>"><?php esc_html_e( 'Duplicar', 'bform' ); ?></a>
								<a class="button" href="<?php echo esc_url( $responses_url ); ?>"><?php esc_html_e( 'Respuestas', 'bform' ); ?></a>
								<a class="button button-secondary bform-confirm-action" href="<?php echo esc_url( $delete_url ); ?>" data-confirm-message="<?php echo esc_attr( __( '¿Estás seguro?', 'bform' ) ); ?>"><?php esc_html_e( 'Eliminar', 'bform' ); ?></a>
								<a class="button button-secondary bform-confirm-action" href="<?php echo esc_url( $delete_clean_url ); ?>" data-confirm-message="<?php echo esc_attr( __( '¿Estás seguro? Se eliminará el formulario y sus respuestas.', 'bform' ) ); ?>"><?php esc_html_e( 'Eliminar + Respuestas', 'bform' ); ?></a>
							</td>
						</tr>
					<?php endforeach; ?>
				<?php endif; ?>
